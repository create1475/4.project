...
<section class="hero-wrapper hero-wrapper4">
    ...
    <div class="video-bg">
        <video src="video/main_viedo.mov" autoplay="true" muted loop="true" width="100%"></video>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
        ...
        <div class="row mt-5">
                ...
                <div class="card-item blog-card">
                    ...
                    <div class="card-content pl-0 pr-0">
                        <ul class="card-meta pl-0 d-flex justify-content-between align-items-center mt-2">
                            <li class="instaTime0">04 Oct, 2022</li>
                            <li></li>
                        </ul>
            ...
            <div class="col-lg-4 column-td-6">
                <div class="card-item blog-card">
                    ...
                    <div class="card-content pl-0 pr-0">
                        <ul class="card-meta pl-0 d-flex justify-content-between align-items-center mt-2">
                            <li class="instaTime1">04 Oct, 2022</li>
                            <li></li>
                        </ul>
            ...
            <div class="col-lg-4 column-td-6">
                <div class="card-item blog-card">
                    ...
                    <div class="card-content pl-0 pr-0">
                        <ul class="card-meta pl-0 d-flex justify-content-between align-items-center mt-2">
                            <li class="instaTime2">04 Oct, 2022</li>
                            <li></li>
                        </ul>
            ...
            <div class="col-lg-4 column-td-6">
                <div class="card-item blog-card">
                    ...
                    <div class="card-content pl-0 pr-0">
                        <ul class="card-meta pl-0 d-flex justify-content-between align-items-center mt-2">
                            <li class="instaTime3">04 Oct, 2022</li>
                            <li></li>
                        </ul>
            ...
            <div class="col-lg-4 column-td-6">
                <div class="card-item blog-card">
                    ...
                    <div class="card-content pl-0 pr-0">
                        <ul class="card-meta pl-0 d-flex justify-content-between align-items-center mt-2">
                            <li class="instaTime4">04 Oct, 2022</li>
                            <li></li>
                        </ul>
            ...
            <div class="col-lg-4 column-td-6">
                <div class="card-item blog-card">
                    ...
                    <div class="card-content pl-0 pr-0">
                        <ul class="card-meta pl-0 d-flex justify-content-between align-items-center mt-2">
                            <li class="instaTime5">04 Oct, 2022</li>
                            <li></li>
                        </ul>
